...
const Login = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        console.error('Endpoint not found:', data.message);
        setErrors({ registerEmail: 'Registration endpoint not found' });
      } else {
  ...
  const handleGoogleLoginSuccess = (googleUser) => {
    ...
    // Proceed with Google login logic
  ...
  return (
    <div className="bg-gradient-to-r from-blue-500 to-purple-600 min-h-screen flex items-center justify-center">
      <div className="max-w-sm w-full p-8 bg-white shadow-lg rounded-md">
        {/* Login Form */}
        {activeForm === 'login' && (
          <form onSubmit={handleLogin} className="mb-4">
            ...
            <p className="text-center mt-4 text-sm text-gray-600">
              <span className="cursor-pointer text-blue-600" onClick={() => switchToForm('register')}>
                Register
              </span>
              &nbsp;|&nbsp;
              <span className="cursor-pointer text-blue-600" onClick={() => switchToForm('forgot-password')}>
                Forgot Password?
              </span>
            </p>
            <GoogleLogin
        ...
        {activeForm === 'register' && (
          <form onSubmit={handleRegister} className="mb-4">
            ...
            <p className="text-center mt-4 text-sm text-gray-600">
              <span className="cursor-pointer text-blue-600" onClick={() => switchToForm('login')}>
                Back to Login
              </span>
            </p>
          </form>
